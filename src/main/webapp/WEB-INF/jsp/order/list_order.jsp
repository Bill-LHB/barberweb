...
<body>
	...
	<div>
		...
		<button style="display:inline"><a href="<%=basePath %>system/addModules.do" style="text-decoration:none;">添加员工</a></button>
	</div>
	...
	<table border="1">
		...
		<c:forEach items="${modulesList}" var="modules">
			<tr>
				...
				<td><a href="<%=basePath %>system/deleteModules/${modules.modules_id}.do">查看</a></td>
				<td><a href="<%=basePath %>system/deleteModules/${modules.modules_id}.do">删除</a></td>
